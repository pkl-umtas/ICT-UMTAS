<template>
    <div class="container">
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-4 g-4 p-4">
        <!-- Kontak -->
        <div class="col">
          <div class="kontak">
            <h5>Kontak</h5>
        ...
        <div class="col">
          <h5>Alamat</h5>
          <hr />
          <h6>Jl. Tamansari No.29, Mulyasari, Kec. Tamansari, Kab. Tasikmalaya</h6>
        </div>
      </div>
